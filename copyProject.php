...
if (isset($_POST['projectId'])) {
    ...
    try {
        ...
        if ($originalProject = mysqli_fetch_assoc($result)) {
            ...
            $insertProjectSql = "INSERT INTO tblproject (ProjectName, BOQTitle, DateUpdated) 
            ...
            $newProjectID = mysqli_insert_id($conn); // Get the new Project ID

            // Step 2: Copy Categories for the New Project
            $categorySql = "SELECT * FROM tblboqcategory WHERE ProjectID = '$projectID'";
            ...
            while ($category = mysqli_fetch_assoc($categoryResult)) {
                ...
                $insertCategorySql = "INSERT INTO tblboqcategory (CategoryName, DateInserted, ProjectID)
                                      VALUES ('$newCategoryName', '$newDateInserted', '$newProjectID')";
